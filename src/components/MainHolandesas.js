...
import Black from "../assets/img/holandesas/8.6-Black.png";
import Original from "../assets/img/holandesas/8.6-Original.png";
...
const data = [
  ...
  },
  {
    title: "8.6 Original ",
    image:
      // "https://swinkelsfamilybrewers.com/en/our-range/alcoholic-beers/8-6/86-original/_jcr_content/root/responsivegrid/productinformation/image.coreimg.1024.png/1572956122987.png",
      Original,
    description:
